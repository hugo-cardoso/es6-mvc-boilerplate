...
},{"./controllers/AppController":29}],29:[function(require,module,exports){
'use strict';
...
var _YouService = require('../services/YouService');

var _YouService2 = _interopRequireDefault(_YouService);
...
var AppController = function () {
  function AppController() {
    ...
    this.youtService = new _YouService2.default();
    this.init();
  }
...
},{"../models/Model":30,"../services/YouService":32}],30:[function(require,module,exports){
"use strict";
...
var YouService = function () {
  function YouService() {
    _classCallCheck(this, YouService);

    this.KEY = '***';
    this.BASE_URL = '...';
  }

  _createClass(YouService, [{
    key: 'search',
    value: function search(query) {

      var url = '' + this.BASE_URL;

      return _HttpService2.default.getData(url);
    }
  }]);
